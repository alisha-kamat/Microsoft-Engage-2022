    ...
    <form action="#" method="post">
	  ...
	  while($row = mysqli_fetch_assoc($result)) { ?>
       ...
       <select name="age" id="age">
          ...
          <option value="Age_Middle">Middle</option>
...
<?php if(strlen($_POST['age'])>0) { ?>
<th><strong><?php echo substr($_POST['age'],4); ?></strong></th>
<?php } 
   else {?>
...
<?php if(strlen($_POST['age'])>0) { ?>
<td><?php echo $row[$_POST['age']]; ?></td>
<?php } 
   else {?>
<td><?php echo $row["Age_Young"]; ?></td>
<td><?php echo $row["Age_Middle"]; ?></td>
<td><?php echo $row["Age_Senior"]; ?></td>
<?php } ?>
