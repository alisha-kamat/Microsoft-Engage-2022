...
<!---cdb code begin-->
    ...
    <center>
	 ...
	 // while($row = mysqli_fetch_assoc($result)) { ?>
          <option value="<?php echo round($i*$range/100000)*100000; ?>"><?php echo "Below ".round($i*$range/100000)*100000; ?></option><?php } ?>
       </select>
       </td>
       <td>
	  ...
	  /*while($row = mysqli_fetch_assoc($result)) { ?>
          ...
          <option value="<?php echo $param*$i; ?>"><?php echo "Below ".$param*$i; ?></option>
          <?php 
          } 
          ?>       
          </select>
              ...
              <div class="modal fade" id="fullscreenModal" tabindex="-1">
                <div class="modal-dialog modal-fullscreen">
                  <div class="modal-content">
                    ...
                    <div class="modal-body"><h6 id="modal_body"></h6>
